...
/* CRIAR CATEGORIA 
INSERT into Categoria (designacao) values ("Não-Especificado");
INSERT into Categoria (designacao) values ("Filmes/Séries");
...
/* CRIAR PLAYLISTS */
INSERT into Playlist (nomePlaylist,categoria,idUser) values ('PL1','Não-Especificado',4);
INSERT into Playlist (nomePlaylist,categoria,idUser) values ('PL2','Não-Especificado',1);
...
INSERT into Utilizador_Media (idUser,idMedia,categoria) values (4,5,'Não-Especificado');
